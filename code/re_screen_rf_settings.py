...
data_rf_amp = {
    ...
    "-20hi": "4c435341b80a208000100ac00eb99a080b0000000000e184a99b618ea181a84a0400",
...
def print_line(s):
    segmap = {128: ['2'], 129: ['2'], 2: ['2'], 3: ['2'], 214: ['2'], 6: ['2'], 8: ['2'], 9: ['2'], 258: ['2'], 14: ['2'], 16: ['2'], 17: ['2'], 131: ['2'], 20: ['2'], 22: ['2'], 24: ['2'], 30: ['2'], 32: ['L'], 240: ['L'], 191: ['2'], 37: ['2'], 116: ['2'], 39: ['2'], 40: ['1'], 41: ['2'], 43: ['2'], 45: ['L'], 176: ['2'], 179: ['L'], 53: ['2'], 55: ['L'], 185: ['L'], 187: ['L'], 188: ['L'], 232: ['2'], 181: ['2'], 192: ['2'], 65: ['L'], 67: ['L'], 197: ['2'], 198: ['L'], 200: ['2'], 202: ['L'], 75: ['L'], 77: ['L'], 78: ['L'], 207: ['2'], 208: ['2'], 82: ['L'], 83: ['2'], 84: ['L'], 213: ['2'], 203: ['2'], 217: ['2'], 218: ['2'], 219: ['2'], 92: ['L'], 223: ['2'], 96: ['S'], 97: ['2'], 99: ['2'], 228: ['3'], 104: ['2'], 107: ['2'], 108: ['2'], 109: ['2'], 111: ['2'], 112: ['L'], 113: ['2'], 115: ['2'], 244: ['0'], 245: ['2'], 246: ['L'], 119: ['2'], 250: ['L'], 123: ['2'], 183: ['2'], 247: ['2']}
